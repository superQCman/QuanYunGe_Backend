...
class Bottleneck1(nn.Module):      # 右侧的 residual block 结构（50-layer、101-layer、152-layer）
    expansion = 4
...
def SE_ResNet50():
    return SE_ResNet(Bottleneck1, [3, 4, 6, 3])


def SE_ResNet101():
    return SE_ResNet(Bottleneck1, [3, 4, 23, 3])


def SE_ResNet152():
    return SE_ResNet(Bottleneck1, [3, 8, 36, 3])